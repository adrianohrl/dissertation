...
\input{1_Pre_Texto/listafiguras.tex}
% Lista de tabelas
...
\textual
% Introdução
\input{3_Capitulos/1_introducao.tex}
% Capítulos
\input{3_Capitulos/2_revisao.tex}
\input{3_Capitulos/3_desenvolvimento.tex}
\input{3_Capitulos/4_resultados.tex}
\input{3_Capitulos/5_conclusao.tex}
...
\input{4_Apendices/a_arch_config.tex}
%\input{4_Apendices/b_app_config.tex}
\input{4_Apendices/c_arch_manifest.tex}
\input{4_Apendices/d_app_manifest.tex}
\input{4_Apendices/e_alliance.tex}
% Anexos - opcional
% \anexos
