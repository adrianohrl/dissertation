\chapter[Desenvolvimento]{Desenvolvimento} \label{cap:desenvolvimento}
    ...
    \section{\textit{rqt\_mrta}}
        ...
        \subsection{Arquivo de configuração de arquitetura} \label{subset:arch_config}
            Seu propósito é:
        ...
        \subsection{Arquivo de configuração de aplicação} \label{subset:app_config}
        ...
        \subsection{Modelo}  \label{subset:model}
            ...
            É mostrado na Figura \ref{fig:rqt_mrta_uml} o diagrama UML (\textit{Unified Modeling Language}) que relaciona as classes do modelo utilizado na camada de controle do \textit{rqt\_mrta}.
